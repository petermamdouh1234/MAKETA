...
export const Frame13Subsection = () => {
  return (
    <section className="relative w-full min-h-[250px] md:min-h-[300px] lg:h-[350px] bg-black border-2 md:border-[3px] border-solid border-white translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms]">
      <div className="flex flex-col md:flex-row items-center justify-between h-full px-4 md:px-8 lg:px-16 py-6 md:py-0 gap-4 md:gap-8">
        <div className="flex-shrink-0 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:800ms]">
